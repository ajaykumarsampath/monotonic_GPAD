function [ Z,Y,details] = GPD_differentFt_cellF(sys,Ptree,Tree,V,ops)
%This function is implements the dual projection algorithm to solve an 
%optimization problem. The inputs the system are the system dynamics, 
%the tree structure, all the off-line elements that are calculated 
%earlier that are to be used by the GPAD. additional options about 
%the inital fesible dual variable.
